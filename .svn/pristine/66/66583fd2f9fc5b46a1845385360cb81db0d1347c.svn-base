 ...
 * @author paul.kline
 */
public class WeightSelectorOld extends javax.swing.JFrame {

    LinkedList<Component> thingsIveAdded = new LinkedList<>();

    /**
     * Creates new form WeightSelectorOld
     *
     * @param CO The controller object to use for communication with this
     * WeightSelectorOld
     */
    public WeightSelectorOld(ControllerObjectOld CO) {
    ...
    public static WeightSelectorOld GetInstance() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Section for Gathering Purposes.");
...
//        dispose();
    ...
    int[] ScoreAndweights;
    private ControllerObjectOld myCO;
    private static WeightSelectorOld visibleWeightSelector;
    ...
    public void man() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WeightSelectorOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void addAllThingsToThingsIveAdded() {
        ...
        thingsIveAdded.add(jLabel1);
        thingsIveAdded.add(jList1);
        thingsIveAdded.add(jPanel1);
