 ...
 * rotated in 90 degree steps and have sideways and downwards movability.<p>
 *
...
public class Figure extends Object {
    ...
    /**
     * The square board to which the figure is attached. If this variable is set
     * to null, the figure is not attached.
     */
    ...
    /**
     * The figure orientation (or rotation). This value is normally between 0
     * and 3, but must also be less than the maxOrientation value.
     *
     * @see #maxOrientation
     */
     ...
     * of possible rotations for some figures, such as the square figure. If
     * this value is not used, the square figure will be possible to rotate
     * around one of its squares, which gives an erroneous effect.
     *
     * @see #orientation
     */
    ...
    /**
     * The vertical coordinates of the figure shape. The coordinates are
     * relative to the current figure position and orientation.
     */
    ...
    public int shapeshape;

    /**
     * Creates a new figure of one of the seven predefined types. The figure
     * will not be attached to any square board and default colors and
     * orientations will be assigned.
     *
     ...
     * visible, or centered onto the board. In both cases, the squares on the
     * new board are checked for collisions. If the squares are already
     * occupied, this method returns false and no attachment is made.<p>
     *
     * The horizontal and vertical coordinates will be reset for the figure,
     * when centering the figure on the new board. The figure orientation
     * (rotation) will be kept, however. If the figure was previously attached
     * to another board, it will be detached from that board before attaching to
     * the new board.
     *
    ...
    public boolean attach(SquareBoard board, boolean center) {
        //System.out.println("I'm attaching");
        int newX;
        int newY;
        int i;
...
//System.out.println("newX, newY, orientation"+ newX + " " 
//                    + newY + " " + orientation);
        // Check position        
        this.board = board;
...
//                    + newY + " " + orientation);
    ...
    /**
     * Detaches this figure from its square board. The figure will not be
     * removed from the board by this operation, resulting in the figure being
     * left intact.
     */
    public void detach() {
        board = null;
    ...
    /**
     * Moves the figure one step to the left. If such a move is not possible
     ...
     * square board bottom, or squares not being empty. If no move is possible
     * with respect to the square board, nothing is done. The square board will
     * be changed as the figure moves, clearing the previous cells. If no square
     * board is attached, nothing is done.
     */
     ...
     * board will be changed as the figure moves, clearing the previous cells.
     * If no square board is attached, the rotation is performed directly.
     *
    ...
    /**
     * Rotates the figure randomly. If such a rotation is not possible with
     * respect to the square board, nothing is done. The square board will be
     * changed as the figure moves, clearing the previous cells. If no square
    ...
    /**
     * Rotates the figure counter-clockwise. If such a rotation is not possible
     * with respect to the square board, nothing is done. The square board will
     * be changed as the figure moves, clearing the previous cells. If no square
     * board is attached, the rotation is performed directly.
     */
     ...
     */
    public boolean canMoveTo(int newX, int newY, int newOrientation) {
        int x;
        int y;
    ...
    /**
     * Returns the relative horizontal position of a specified square. The
     * square will be rotated according to the specified orientation.
     *
    ...
    public Point[] GetOnBoardLocation(){
        int x;
        int y;
        Point[] points= new Point[shapeX.length];
