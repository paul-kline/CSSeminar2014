...
import NewTetrisDecoratorPackage.GameInterface1;
 ...
 */
public class Game extends Object implements GameInterface1 {
    ...
    @Override
    public void setUseWeights(boolean b){ UseWeights=b;}
    @Override
    ...
    private WeightSelectorOld myWS;
...
double curAve=0;
 ...
 //       System.out.println("called");
    ...
    void setUseThisNN(NNCodes n) {
        NNCode=n;
    }

    protected void SetWeightSelector(WeightSelectorOld ws) {
        myWS = ws;
        }

    public void MovePieceHelper(PlacementDecider pcp) {
...
//                }
            ...
            //GetInstance().SetWeightSelector(WeightSelectorOld.Constructor(CO));
            //CO.setGame(GetInstance());
//            myWS = new WeightSelectorOld(CO);
//            myWS.setVisible(true);
            ...
            c = new GridBagConstraints();
                ...
                public void actionPerformed(ActionEvent ae) {
                    WeightSelectorOld.GetInstance().setVisible(true);
                }
            });
                try {
                    Thread.sleep(5);
...
//                CO.setWeightSelector(WeightSelectorOld.GetInstance());
//                CO.setGame(GetInstance());
